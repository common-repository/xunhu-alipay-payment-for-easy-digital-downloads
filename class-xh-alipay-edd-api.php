...
class XH_Alipay_Payment_EDD_Api{
    ...
    public function register_activation_hook(){
        ...
        if(empty($val)){
            edd_update_option('xh_alipay_payment_edd_transaction_url','https://pay.xunhupay.com/v2');
        }
